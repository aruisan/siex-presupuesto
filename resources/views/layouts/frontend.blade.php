                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown li-nav_2">
                      ...
                      <ul class="dropdown-menu">
                        <li><a href="#">Inscripción Industria y Comercio</a></li>
                        <li><a href="#">Retiro Inscripción Industria y Comercio</a></li>
                        <li><a href="#">Declaración y pago de impuestos municipales</a></li>
                      </ul>
                    </li>
                    <li class="dropdown li-nav_2">
