                   ...
                   <form  method="post" action="{{route('rubro.store')}}">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="cpc_id" class="form-control input_text col-sm-7">
                     ...
                     <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="detalle_sectorial_id" class="form-control input_text col-sm-7">
                     ...
                     <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="fuente_de_financiacion_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="politica_publica_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="producto_mga_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="programa_mga_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="pub_presupuesto_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="seccion_presupuestal_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="seccion_presupuestal_adicional_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="sector_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="situacion_de_fondo_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="tercero_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="tipo_de_norma_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="vigencia_gasto_id" class="form-control input_text col-sm-7">
                    ...
                    <div class="row">
                        <div class="input-group my-2 col-md-12">
                            ...
                            <select name="dependencia_id" class="form-control input_text col-sm-7">
